        ...
        link: function (scope, element, attrs, controller) {
            ...
            controller.getMap().then(function (map) {
                ...
                function _watchBaseFn(name) {
                    ...
                    maybeWatch(leafletScope, baseWatchPath, { type: 'watchCollection' },
                        function (layerData, old, clearWatch) {
                            if (layerData === old) {
                                return;
                            }
                ...
                function _watchOverlayFn(name) {
                    ...
                    maybeWatch(leafletScope, overlayWatchPath, { type: 'watchCollection' },
                        function (layerData, old, clearWatch) {
                            if (layerData === old) { return; }
                            if (!isDefined(layerData)) {
                ...
                function _updateOverlayLayer(name, layerData, old) {
                    ...
                    if (map.hasLayer(leafletLayers.overlays[name])) {
                        ...
                        if (isDefined(layerData.index) && ly.setZIndex &&
                            layerData.index !== old.index) {
